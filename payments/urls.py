...
urlpatterns = [
    ...
    # Tuition payment URLs
    path("tuition-payment/", views.TuitionPaymentView.as_view(), name="tuition_payment"),
    path("payment-history/", views.tuition_payment_history, name="tuition_payment_history"),
    path("admin-tuition-management/", views.admin_tuition_management, name="admin_tuition_management"),
    path("create-tuition-fee/", views.create_tuition_fee, name="create_tuition_fee"),
]
